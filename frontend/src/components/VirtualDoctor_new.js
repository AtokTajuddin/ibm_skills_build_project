  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-800">AI Healthcare Assistant</h1>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg font-medium transition-colors duration-200 flex items-center"
              >
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 rounded-lg font-medium transition-colors duration-200 flex items-center"
              >
                <span className="mr-2">✨</span>
                New Chat
              </button>
      ...
      <div className="max-w-4xl mx-auto p-4 flex gap-6">
        {/* History Sidebar */}
        {showHistory && (
          <div className="w-80 bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 h-fit">
        ...
        <div className="flex-1">
          {/* Messages Container */}
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 mb-6 h-96 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                <textarea
                  ...
                  className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none h-24 bg-white/80 backdrop-blur-sm"
                  disabled={loading}
                  onKeyDown={(e) => {
